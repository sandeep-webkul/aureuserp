<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <x-filament::section>
            ...
            <x-slot name="heading">
                {{ __('accounting::filament/clusters/reporting.common.from-to', ['report' => __('accounting::filament/clusters/reporting.pages.partner-ledger.navigation.title'), 'from' => \Carbon\Carbon::parse($data['date_from'])->format('M d, Y'), 'to' => \Carbon\Carbon::parse($data['date_to'])->format('M d, Y')]) }}
            </x-slot>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-white/5!">
                    ...
                    <thead class="bg-gray-50/50 dark:bg-white/5">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400">{{ __('accounting::filament/clusters/reporting.common.journal') }}</th>
                            ...
                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400">{{ __('accounting::filament/clusters/reporting.common.invoice-date') }}</th>
                            <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-400">{{ __('accounting::filament/clusters/reporting.common.due-date') }}</th>
