...
namespace Webkul\Support\Filament\Resources\ActivityTypeResource\Tables;
...
{
    public static function configure(Table $table, ?string $pluginName = null): Table
    {
        return $table
            ->reorderableColumns()
            ->columns([
            ...
            ->modifyQueryUsing(fn ($query) => $query->where('plugin', $pluginName))
            ->reorderable('sort');
    }
}
