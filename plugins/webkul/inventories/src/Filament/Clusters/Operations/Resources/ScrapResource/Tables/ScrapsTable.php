...
namespace Webkul\Inventory\Filament\Clusters\Operations\Resources\ScrapResource\Tables;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('lot.name')
                    ...
                    ->sortable()
                    ->placeholder('—')
                    ->visible(ScrapResource::getTraceabilitySettings()->enable_lots_serial_numbers),
            ...
            ->groups(
                collect([
                    ...
                    return match ($group->getId()) {
                        'sourceLocation.full_name', 'destinationLocation.full_name' => ScrapResource::getWarehouseSettings()->enable_locations,
                        default                                                     => true
                    };
                })->all()
            )
            ->filters([
                QueryBuilder::make()
                    ->constraints(collect([
                        ScrapResource::getWarehouseSettings()->enable_locations
                        ...
                        ScrapResource::getProductSettings()->enable_uom
                        ...
                        ScrapResource::getTraceabilitySettings()->enable_lots_serial_numbers
                            ...
                            : null,
                        ScrapResource::getOperationSettings()->enable_packages
