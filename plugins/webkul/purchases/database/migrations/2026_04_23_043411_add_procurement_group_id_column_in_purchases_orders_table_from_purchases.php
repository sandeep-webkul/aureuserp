...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('purchases_orders', function (Blueprint $table) {
            if (Schema::hasTable('inventories_procurement_groups') && ! Schema::hasColumn('purchases_orders', 'procurement_group_id')) {
    ...
    {
        Schema::table('purchases_orders', function (Blueprint $table) {
            if (Schema::hasColumn('purchases_orders', 'procurement_group_id')) {
