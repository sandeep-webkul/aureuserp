...
namespace Webkul\Sale\Filament\Clusters\Orders\Resources\QuotationResource\Tables;
    ...
    public static function configure(Table $table, string $resource, array $customColumns = [], array $customConstraints = []): Table
    {
        return $table
            ...
            ->checkIfRecordIsSelectableUsing(
                fn (Model $record): bool => $resource::can('delete', $record) && $record->state !== OrderState::SALE,
            )
