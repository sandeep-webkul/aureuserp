        ...
        <table class="details-table">
            <tr>
                @if ($record->invoice_date)
                    <td width="33%">
                        <strong>{{ __('accounts::account-manager.documents.labels.invoice-date') }}</strong><br>
                        {{ $record->invoice_date }}
                    </td>
                @endif
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="amount" style="border-top: 1px solid #FFFFFF;"><b>{{ money($record->amount_total, $record->currency->name) }}</b></td>
                    </tr>
                </tbody>
            </table>
        </div>
