...
return [
    ...
    'auth' => [
        'forbidden'         => 'ليس لديك إذن لاستخدام تطبيق الباركود.',
    ...
    'adjustments' => [
        ...
        'product-unavailable' => 'هذا المنتج غير متاح في شركتك النشطة. بدّل الشركة لتعديله.',
        'count-saved'         => 'تم عد :quantity :uom (:difference مقارنة بالمتوفر). اضغط تطبيق لتحديث المخزون.',
        'count-set'           => 'تم ضبط العدد على :quantity :uom، مطابق للمتوفر.',
        'count-unchanged'     => 'الكمية المعدودة تطابق المتوفر مسبقاً (:quantity :uom). لم يتغير المخزون.',
        'difference'          => 'الفرق',
        'count-applied'       => 'تم تطبيق تسوية المخزون. المتوفر الآن :quantity :uom (:difference).',
    ...
    'manufacturing' => [
        'title'                     => 'أوامر التصنيع',
        'subtitle'                  => 'امسح المكونات وسجل الإنتاج',
        'search'                    => 'امسح أو ابحث برقم الأمر أو المنتج أو الباركود...',
        'scan'                      => 'امسح مكوناً أو المنتج النهائي...',
        'empty'                     => 'لا توجد أوامر تصنيع.',
        'empty-components'          => 'لا توجد مكونات.',
        'not-found'                 => 'لم يتم العثور على أمر تصنيع مفتوح لهذا الباركود.',
        'multiple-found'            => 'تم العثور على :count أمر تصنيع مطابق.',
        'components'                => 'المكونات',
        'to-produce'                => 'للإنتاج',
        'producing'                 => 'قيد الإنتاج',
        'to-consume'                => 'للاستهلاك',
        'consumed'                  => 'المستهلك',
        'source-location'           => 'موقع المكونات',
        'produce-all'               => 'إنتاج الكل',
        'produce-all-applied'       => 'تم تطبيق كميات الإنتاج الكاملة.',
        'confirm'                   => 'تأكيد',
        'start'                     => 'بدء',
        'done'                      => 'وضع علامة كمنتهٍ',
        'finished-scanned'          => 'تم مسح المنتج النهائي. تمت زيادة كمية الإنتاج.',
        'component-scanned'         => 'تم مسح المكون. تمت زيادة الكمية المستهلكة.',
        'component-not-on-order'    => 'هذا المنتج ليس مكوناً في أمر التصنيع هذا.',
        'component-counted'         => 'تم حفظ كمية المكون.',
        'component-editor-title'    => 'تفاصيل المكون',
        'component-editor-subtitle' => 'راجع المكون وحدّث الكمية المستهلكة.',
        'component-edit-tooltip'    => 'تعديل المكون',
    ],
    ...
    'actions' => [
        'draft-blocked'            => 'هذا التحويل لا يزال مسودة. أكّده في لوحة الإدارة قبل اعتماده هنا.',
        'product-unavailable'      => ':count سطر يستخدم منتجاً غير متاح في شركتك النشطة. بدّل الشركة للمتابعة.',
        'confirm'                  => 'تأكيد',
